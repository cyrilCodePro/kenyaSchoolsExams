...
namespace iTech
{
    public partial class BottomClass : Form
    {
        public BottomClass()
        {
            InitializeComponent();
        ...
        private void BottomClass_Load(object sender, EventArgs e)
        {
        ...
        private void comboForm_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                this.CatsTableAdapter.FillBy1(this.iTechData.Cats, comboForm.Text);
